...
**Task**: Parallalelize the provided hash cracker code. Show us the resulting code and logs from running it with Ray on Golem.

**Steps**:
- Consider the provided piece of code.
- Parallelize it with Ray (ie make it run faster for bigger inputs)
...
You will notice that it runs very fast for hashes of 3-character-words, okish for 4-character words (30-120 seconds) and very slowly for longer words (over 20 mins for 5-character-words).
